    ...
    return (
        <Container>
          ...
          <Menu>
            ...
            <Menu.Item>
              <ProfileVendor key={this.state.userProfile._id} user={this.state.userProfile} size={'small'}/>
            </Menu.Item>
          </Menu>
          ...
          <Table celled>
            ...
            <Table.Body>
              {this.state.userProfile.items.map((item, index) => <VendorItem key={index} vendor={item} />)}
            </Table.Body>
          </Table>
        </Container>
    );
